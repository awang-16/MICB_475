...
**Proposal** https://docs.google.com/document/d/1JRAL2CkS1oAsJiSYHNGe7Iyd_YzBbKJBOPZpviwnq44/edit

[Oct 2](#oct-2) ; [Oct 5](#oct-5) ; [Oct 12](#oct-12) ; [Oct 19](#oct-19) ; [Oct 26](#oct-26) ; [Nov 2](#nov-2) ; [Nov 9](#nov-9) ; [Nov 23](#nov-23); [Nov 30](#nov-30)

**Manuscript draft**  due Dec 10th

**Final submission** (manuscript annotated + clean, notebook, response to editors) due Dec 20th
...
| Agenda item                                                                        	| Conclusion 	|
|-----------------------------------------	|---------	|
| Alpha diversity: no significant data is shown between the groups                        | Ok! Will show figures anyways, but focus on the specifics of pathways etc.  |
| Distribute tasks for manuscript writing?                        | See below |
| Analyses Comparisons: how do we get the top 10 pathways? | Resolved |  
