...
p <- c(gg_pcoa_wunifrac_smoking_LDL,gg_pcoa_wunifrac_nonsmoking_LDL)
save_plots(p)
ggsave(gg_pcoa_wunifrac_smoking_LDL,file="gg_pcoa_wunifrac_smoking_LDL.png")
ggsave(gg_pcoa_wunifrac_nonsmoking_LDL,file="gg_pcoa_wunifrac_nonsmoking_LDL.png")
```
